import { LifebuoyIcon, LightBulbIcon , ArrowTrendingUpIcon, UsersIcon  } from "@heroicons/react/24/outline";
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-[#7c2368]">
                    <feature.icon
